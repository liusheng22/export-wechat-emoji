...
```bash
curl -fsSL https://raw.githubusercontent.com/liusheng22/export-wechat-emoji/main/scripts/install-wxemoticon.sh | env WXEMOTICON_VERSION=v0.1.2 bash
```
...
# 升级到指定版本
wxemoticon update --version v0.1.2
```
